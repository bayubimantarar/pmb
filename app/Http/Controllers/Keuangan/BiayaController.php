...
class BiayaController extends Controller
{
    ...
    public function data()
    {
        ...
        return DataTables::of($biaya)
            ->addColumn('action', function($biaya){
                return '<center><a href="/keuangan/biaya/form-ubah/'.$biaya->id.'" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a> <a href="#hapus" onclick="destroy('.$biaya->id.')" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a></center>';
            })
            ->rawColumns(['action'])
            ->make(true);
    }
    ...
    {
        return view('keuangan.biaya.biaya');
    }
    ...
    {
        return view('keuangan.biaya.form_tambah');
    }
    ...
    public function store(BiayaRequest $biayaReq)
    {
        ...
        return redirect('/keuangan/biaya');
    }
    ...
    public function edit($id)
    {
        ...
        return view('keuangan.biaya.form_ubah', compact('biaya'));
    }
