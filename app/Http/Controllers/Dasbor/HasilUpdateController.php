...
class HasilUpdateController extends Controller
{
    ...
    public function data($kodeJadwalUjian)
    {
        ...
        return DataTables::of($hasilUpdate)
            ->addColumn('action', function($hasilUpdate) use ($kodeJadwalUjian){
                return '<center><a href="/dasbor/hasil-ujian/'.$kodeJadwalUjian.'/kirim-email/'.$hasilUpdate->id.'" class="btn btn-xs btn-success"><i class="fa fa-envelope"></i></a> <a href="/dasbor/hasil-ujian/'.$kodeJadwalUjian.'/unduh/'.$hasilUpdate->id.'" class="btn btn-primary btn-xs" title="Unduh formulir"><i class="fa fa-download"></i></a></center>';
            })
    ...
    public function index($kodeJadwalUjian)
    {
        ...
        return view('dasbor.kelulusan.kelulusan', compact(
    ...
    public function store($kodeJadwalUjian, Request $req)
    {
        ...
        return redirect('/dasbor/hasil-ujian/'.$kodeJadwalUjian);
    }
    ...
    public function edit($kodeJadwalUjian, $id)
    {
        ...
        return view('dasbor.kelulusan.form_ubah', compact(
            'hasil'
        ));
    }
