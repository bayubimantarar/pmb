...
class GelombangController extends Controller
{
    ...
    public function data()
    {
        ...
        return DataTables::of($gelombang)
            ->addColumn('action', function($gelombang){
                return '<center><a href="/panitia/pmb/gelombang/form-ubah/'.$gelombang->id.'" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a> <a href="#hapus" onclick="destroy('.$gelombang->id.')" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a></center>';
            })
    ...
    public function index()
    {
        ...
        return view('panitia.pmb.gelombang.gelombang', compact('gelombang'));
    }
    ...
    public function create()
    {
        ...
        return view('panitia.pmb.gelombang.form_tambah', compact('gelombang'));
    }
    ...
    public function store(GelombangRequest $gelombangReq)
    {
        ...
        return redirect('/panitia/pmb/gelombang');
    }
    ...
    public function edit($id)
    {
        ...
        return view('panitia.pmb.gelombang.form_ubah', compact(
            'gelombang',
            'dariTanggal',
            'sampaiTanggal'
        ));
