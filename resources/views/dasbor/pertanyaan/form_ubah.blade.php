    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="/dasbor/pertanyaan/{{ $kodesoal }}/ubah/{{ $pertanyaan->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-xs-12">
                                        ...
                                        <select name="jenis_pertanyaan" id="jenis-pertanyaan" class="form-control">
                                            @if($pertanyaan->jenis_pertanyaan == "essay")
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-xs-12">
                                        ...
                                        <input type="number" name="bobot" class="form-control" value="{!! $pertanyaan->bobot !!}" />
                                    </div>
                                </div>
                            </div>
