...
@section('title')
Dasbor &raquo; Master &raquo; Tahun Ajaran &raquo; Form Ubah Data Tahun Ajaran
@endsection
...
<div class="row">
    <div class="col-lg-12">
        ...
        @endif
        <p>
            <a href="/dasbor/master/tahun-ajaran/form-tambah" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Tahun Ajaran</a>
        </p>
      ...
      function destroy(id)
      {
        ...
        if (confirmation) {
            $.ajax({
                ...
                url: '/dasbor/master/tahun-ajaran/hapus/'+id,
                type: 'delete',
                dataType: 'json',
