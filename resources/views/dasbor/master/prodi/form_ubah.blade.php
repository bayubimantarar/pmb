...
@section('title')
Dasbor &raquo; Kelas &raquo; Form Ubah Data Kelas
@endsection
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="/dasbor/master/prodi/ubah/{{ $prodi->id }}" method="post">
                            @csrf
                            ...
                            <div class="form-group {{$errors->has('kode') ? ' has-error' : ''}}">
                                <div class="row">
                                    <div class="col-lg-5 col-md-5 col-xs-12">
                                        ...
                                        <input type="text" name="kode" class="form-control" value="{{ $prodi->kode }}" />
                                        @if($errors->has('kode'))
