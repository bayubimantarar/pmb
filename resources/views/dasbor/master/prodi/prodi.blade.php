...
@section('title')
Dasbor &raquo; Master &raquo; Prodi &raquo; Form Tambah Data Prodi
@endsection
...
<div class="row">
    <div class="col-lg-12">
        ...
        @endif
        <p>
            <a href="/dasbor/master/prodi/form-tambah" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Prodi</a>
        </p>
      ...
      function destroy(id)
      {
        ...
        if (confirmation) {
            $.ajax({
                ...
                url: '/dasbor/master/prodi/hapus/'+id,
                type: 'delete',
                dataType: 'json',
