...
@section('title')
Dasbor &raquo; Pengguna &raquo; Panitia &raquo; Form Tambah Data Panitia
@endsection

@section('content')
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Form Tambah Data Panitia</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
<div class="row">
    <div class="col-lg-12">
        <ul class="breadcrumb">
            ...
            <li><a href="/dasbor/pengguna/keuangan">Data Panitia</a></li>
            <li class="active">Form Tambah Data Panitia</li>
        </ul>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="/dasbor/pengguna/keuangan/simpan" method="post">
                            @csrf
                            <h1>Data Diri</h1>
                            <hr />
