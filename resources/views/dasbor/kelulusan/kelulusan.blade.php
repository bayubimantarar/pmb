...
@section('title')
dasbor &raquo; PMB &raquo; Data Hasil Ujian
@endsection
...
@push('js')
    ...
    var kode_jadwal_ujian = "{{ $kodeJadwalUjian }}";
      var hasil_ujian_table = $("#hasil-ujian-table").DataTable({
        serverSide: true,
        processing: true,
        ajax: '/dasbor/hasil-ujian/'+kode_jadwal_ujian+'/data',
        columns: [
      ...
      var hasil_ujian_update_table = $("#hasil-ujian-update-table").DataTable({
        ...
        $("#filter").click(function(){
            ...
            if(kode_jurusan == ""){
                ...
                var url = "/dasbor/pmb/hasil-ujian/data/cari/"+kode_jurusan+"/"+kode_gelombang+"/"+kode_kelas+"/"+tahun;
                $.ajax({
                    url: url,
                    type: "GET",
                    dataType: 'json',
