    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="/keuangan/detail-potongan/{{$kodePotongan}}/ubah/{{$id}}" method="post">
                            @csrf
                            ...
                            <div class="form-group {{ $errors->has('deskripsi') ? ' has-error' : ''}}">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-12">
                                        ...
                                        <textarea name="deskripsi" class="form-control" rows="5">{{$detailPotongan->deskripsi}}</textarea>
                            ...
                            <div class="form-group {{ $errors->has('jumlah') ? ' has-error' : ''}}">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-12">
                                        ...
                                        <input type="number" name="jumlah" value="{{$detailPotongan->jumlah}}" class="form-control" />
