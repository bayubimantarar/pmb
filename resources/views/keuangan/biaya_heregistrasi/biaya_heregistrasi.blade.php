...
<div class="row">
    <div class="col-lg-12">
        @if($jumlah == 0)
            <p>
                <a href="/keuangan/biaya-heregistrasi/form-tambah" class="btn btn-primary">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table width="100%" class="table table-striped table-bordered table-hover" id="biaya-heregistrasi">
                        <thead>
                            <tr>
                                <th>Jumlah</th>
                                <th>Opsi</th>
...
@push('js')
    ...
    <script>
      var biaya_heregistrasi_table = $("#biaya-heregistrasi").DataTable({
        serverSide: true,
        processing: true,
        ajax: '/keuangan/biaya-heregistrasi/data',
        columns: [
            {data: 'jumlah'},
    ...
    function destroy(id)
    {
        ...
        if (confirmation) {
            $.ajax({
                ...
                url: '/keuangan/biaya-heregistrasi/hapus/'+id,
                type: 'delete',
                dataType: 'json',
                success: function(result){
                    alert('Data berhasil dihapus!');
                    biaya_heregistrasi_table.ajax.reload();
                }
            });
        }
    }
