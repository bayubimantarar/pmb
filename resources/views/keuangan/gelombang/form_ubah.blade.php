...
<div class="row">
    <div class="col-lg-12">
        <ul class="breadcrumb">
            ...
            <li><a href="/dosen/soal">Data Gelombang</a></li>
            <li class="active">Form Tambah Data Gelombang</li>
        </ul>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="/keuangan/gelombang/ubah/{{$gelombang->id}}" method="post">
                            @csrf
                            ...
                            <div class="form-group {{ $errors->has('kode') ? ' has-error' : ''}}">
                                <div class="row">
                                    <div class="col-lg-5 col-md-5 col-xs-12">
                                        ...
                                        <input type="text" name="kode" class="form-control" id="kode" value="{{ $gelombang->kode }}" readonly/>
                                        @if($errors->has('kode'))
                                            <p class="text-danger">
                                ...
                                <div class="col-lg-3 col-md-3 col-xs-12">
                                    <div class="form-group {{$errors->has('dari_tanggal') ? ' has-error' : ''}}">
                                        ...
                                        <div class='input-group date' id="dari-tanggal">
                                            <input type="text" name="dari_tanggal" class="form-control dari-tanggal" value="{{ $dariTanggal }}" />
                                ...
                                <div class="col-lg-3 col-md-3 col-xs-12">
                                    <div class="form-group {{$errors->has('sampai_tanggal') ? ' has-error' : ''}}">
                                        ...
                                        <div class='input-group date' id="sampai-tanggal">
                                            <input type="text" name="sampai_tanggal" class="form-control" value="{{ $sampaiTanggal}}" />
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-5 col-md-5 col-xs-12">
                                        ...
                                        <input type="number" name="jumlah_potongan" class="form-control" value="{{ $gelombang->jumlah_potongan }}" />
                                    </div>
                                </div>
                            </div>
