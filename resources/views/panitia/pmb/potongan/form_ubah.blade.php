    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="/panitia/pmb/potongan/ubah/{{ $potongan->id }}" method="post">
                            @csrf
                            ...
                            <div class="form-group {{ $errors->has('deskripsi') ? ' has-error' : ''}}">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-12">
                                        ...
                                        <input type="text" name="deskripsi" class="form-control" value="{{ $potongan->deskripsi }}" />
                            ...
                            <div class="form-group {{ $errors->has('jumlah_potongan') ? ' has-error' : ''}}">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-12">
                                        ...
                                        <input type="number" name="jumlah_potongan" class="form-control" value="{{ $potongan->jumlah_potongan }}" />
                            ...
                            <a href="/panitia/pmb/potongan" class="btn btn-default"><i class="fa fa-times"></i> Batal</a>
                        </form>
                    </div>
                    <!-- /.col-lg-12 (nested) -->
                </div>
