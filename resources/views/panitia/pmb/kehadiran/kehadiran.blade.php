...
@section('title')
Panitia &raquo; PMB &raquo; Data kehadiran
@endsection
...
@push('js')
    ...
    <script>
      var kehadiran_table = $("#kehadiran-table").DataTable({
        serverSide: true,
        processing: true,
        ajax: '/panitia/pmb/kehadiran/data',
        columns: [
            {data: 'kode_pendaftaran'},
            {data: 'kode_jadwal_ujian'},
            {data: 'nama'}
        ]
      });
    ...
    function destroy(id)
    {
        ...
        if (confirmation) {
            $.ajax({
                ...
                url: '/panitia/pmb/kehadiran/hapus/'+id,
                type: 'delete',
                dataType: 'json',
                success: function(result){
                    alert('Data berhasil dihapus!');
                    kehadiran_table.ajax.reload();
                }
            });
        }
    }
