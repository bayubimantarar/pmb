...
<div class="row">
    <div class="col-lg-12">
        <p>
            <a href="/prodi/pmb/soal/pertanyaan/{{ $tempkodesoal }}/form-tambah" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Pertanyaan</a>
        </p>
...
@push('js')
    ...
    <script>
        ...
        var pertanyaan_table = $('#pertanyaan-table').DataTable({
            serverSide: true,
            processing: true,
            ajax: '/prodi/pmb/soal/pertanyaan/'+kodesoal+'/data',
            columns: [
                {data: 'pertanyaan'},
        ...
        function destroy(id)
        {
            ...
            if (confirmation) {
                $.ajax({
                    ...
                    url: '/prodi/pmb/soal/pertanyaan/'+kodesoal+'/hapus/'+id,
                    type: 'delete',
                    dataType: 'json',
